...
/**
 * Class ginger_klarnapaylater
 */
class ginger_klarnapaylater extends gingerGateway
{
    public $code = 'ginger_klarnapaylater';

    /**
     * ginger_klarnapaylater constructor.
     */
    function __construct()
    {
        $this->title = MODULE_PAYMENT_GINGER_KLARNAPAYLATER_TEXT_TITLE;
        $this->description = MODULE_PAYMENT_GINGER_KLARNAPAYLATER_TEXT_DESCRIPTION;
        $this->sort_order = MODULE_PAYMENT_GINGER_KLARNAPAYLATER_SORT_ORDER;
        $this->enabled = ((MODULE_PAYMENT_GINGER_KLARNAPAYLATER_STATUS == 'True')?true:false);
    ...
    public function install()
    {
        ...
        if (defined('MODULE_PAYMENT_GINGER_KLARNAPAYLATER_STATUS')) {
            $messageStack->add_session(MODULE_PAYMENT_GINGER_KLARNAPAYLATER_ERROR_ALREADY_INSTALLED, 'error');
            zen_redirect(zen_href_link(FILENAME_MODULES, 'set=payment&module='.$this->code, 'SSL'));
            return 'failed';
        }

        $this->setConfigurationField([
            'configuration_title' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_STATUS_TEXT,
            'configuration_description' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_STATUS_DESCRIPTION,
            'configuration_key' => 'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_STATUS',
        ...
        $this->setConfigurationField([
            'configuration_title' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_DISPLAY_TITLE_TEXT,
            'configuration_description' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_DISPLAY_TITLE_DESCRIPTION,
            'configuration_key' => 'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_DISPLAY_TITLE',
            'configuration_value' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_TEXT_TITLE,
            'configuration_group_id' => 6,
            'sort_order' => 2
        ]);
        ...
        $this->setConfigurationField([
            'configuration_title' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_SORT_ORDER_TEXT,
            'configuration_description' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_SORT_ORDER_DESCRIPTION,
            'configuration_key' => 'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_SORT_ORDER',
        ...
        $this->setConfigurationField([
            'configuration_title' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_ZONE_TEXT,
            'configuration_description' => MODULE_PAYMENT_GINGER_KLARNAPAYLATER_ZONE_DESCRIPTION,
            'configuration_key' => 'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_ZONE',
            'configuration_value' => 0,
            'configuration_group_id' => 6,
            'sort_order' => 6,
    ...
    {
        return array(
            'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_DISPLAY_TITLE',
            'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_TEST_API_KEY',
            'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_IP_FILTERING',
            'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_STATUS',
            'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_SORT_ORDER',
            'MODULE_PAYMENT_GINGER_KLARNAPAYLATER_ZONE'
        );
    }
    ...
    public function after_process()
    {
        ...
        try {
            ...
            static::addOrderHistory($this->getOrderId(), static::getZenStatusId($gingerOrder), $gingerOrder['id']);
            ...
            if ($gingerOrder['status'] == 'error') {
                ...
                $messageStack->add_session(
                    'checkout_payment',
                    MODULE_PAYMENT_GINGER_KLARNAPAYLATER_ERROR_TRANSACTION_IS_CANCELLED,
                    'error'
                );
                zen_redirect(zen_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL'));
            }
    ...
    {
        return $this->updateModuleVisibility(MODULE_PAYMENT_GINGER_KLARNAPAYLATER_ZONE);
    }
    ...
    {
        $gingerKlarnaPayLaterIpList = MODULE_PAYMENT_GINGER_KLARNAPAYLATER_IP_FILTERING;
