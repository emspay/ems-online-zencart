 ...
 */
class emspay_klarnapaynow extends emspayGateway
{
    public $code = 'emspay_klarnapaynow';

    /**
     * emspay_klarnapaynow constructor.
     */
    function __construct()
    {
        $this->title = MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_TEXT_TITLE;
    ...
    public function install()
    {
        ...
        if (defined('MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_STATUS')) {
            $messageStack->add_session(MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_ERROR_ALREADY_INSTALLED, 'error');
            zen_redirect(zen_href_link(FILENAME_MODULES, 'set=payment&module='.$this->code, 'SSL'));
            return 'failed';
        }

        $this->setConfigurationField([
            'configuration_title' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_STATUS_TEXT,
            'configuration_description' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_STATUS_DESCRIPTION,
        ...
        $this->setConfigurationField([
            'configuration_title' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_DISPLAY_TITLE_TEXT,
            'configuration_description' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_DISPLAY_TITLE_DESCRIPTION,
            'configuration_key' => 'MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_DISPLAY_TITLE',
            'configuration_value' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_TEXT_TITLE,
            'configuration_group_id' => 6,
            'sort_order' => 1
        ]);

        $this->setConfigurationField([
            'configuration_title' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_SORT_ORDER_TEXT,
            'configuration_description' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_SORT_ORDER_DESCRIPTION,
        ...
        $this->setConfigurationField([
            'configuration_title' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_ZONE_TEXT,
            'configuration_description' => MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_ZONE_DESCRIPTION,
    ...
    {
        return array(
            'MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_DISPLAY_TITLE',
    ...
    public function after_process()
    {
        ...
        try {
            ...
            if ($emsOrder['status'] == 'error') {
                $messageStack->add_session('checkout_payment', MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_ERROR_TRANSACTION, 'error');
    ...
    {
        return $this->updateModuleVisibility(MODULE_PAYMENT_EMSPAY_KLARNAPAYNOW_ZONE);
    }
}
