...
define('MODULE_PAYMENT_EMSPAY_KLARNA_STATUS_TEXT', "Activer le module Klarna Pay Later");
define('MODULE_PAYMENT_EMSPAY_KLARNA_STATUS_DESCRIPTION', "Voulez-vous activer Klarna Pay Later?");

define('MODULE_PAYMENT_EMSPAY_KLARNA_SORT_ORDER_TEXT', "Ordre de tri pour Klarna Pay Later");
...
define('MODULE_PAYMENT_EMSPAY_KLARNA_TEST_API_KEY_DESCRIPTION', "Entrez ici le clé API de Test pour tester la mise en œuvre de Klarna Pay Later.Si vous n'offrez pas Klarna Pay Later, vous pouvez le laisser vide.");

define('MODULE_PAYMENT_EMSPAY_KLARNA_IP_FILTERING_TEXT', "L’adresse(s) IP pour tester Klarna Pay Later");
define('MODULE_PAYMENT_EMSPAY_KLARNA_IP_FILTERING_DESCRIPTION', "L’adresse(s) IP pour tester Klarna Pay Later. Vous pouvez spécifier des adresses IP spécifiques pour lesquelles Klarna Pay Later est visible. Si vous remplissez rien, alors, Klarna Pay Later est visible à toutes les adresses IP. (par exemple si vous souhaitez tester Klarna Pay Later, vous pouvez saisir des adresses IP comme 128.0.0.1, 255.255.255.255.)");
...
define('MODULE_PAYMENT_EMSPAY_KLARNA_ERROR_ALREADY_INSTALLED', "Le module Klarna Pay Later Pay Later est déjà installé.");
define('MODULE_PAYMENT_EMSPAY_KLARNA_ERROR_TRANSACTION_IS_CANCELLED', "Malheureusement, nous ne pouvons pas actuellement accepter votre achat avec Klarna Pay Later. Veuillez choisir une autre option de paiement pour compléter votre commande. Nous nous excusons pour le dérangement.");
